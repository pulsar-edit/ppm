...
(function() {
  ...
  describe("apm init", function() {
    var languagePath, packagePath, ref, themePath;
    ref = [], packagePath = ref[0], themePath = ref[1], languagePath = ref[2];
    beforeEach(function() {
      var currentDir;
      silenceOutput();
      spyOnToken();
    ...
    describe("when creating a package", function() {
      describe("when package syntax is CoffeeScript", function() {
        return it("generates the proper file structure", function() {
          var callback;
          callback = jasmine.createSpy('callback');
          apm.run(['init', '--package', 'fake-package'], callback);
          waitsFor('waiting for init to complete', function() {
      ...
      describe("when package syntax is JavaScript", function() {
        return it("generates the proper file structure", function() {
          var callback;
          callback = jasmine.createSpy('callback');
      ...
      describe("when package syntax is unsupported", function() {
        return it("logs an error", function() {
          ...
          return runs(function() {
            return expect(callback.argsForCall[0][0].length).toBeGreaterThan(0);
          });
        });
      });
      return describe("when converting a TextMate bundle", function() {
        beforeEach(function() {
          var callback, textMateBundlePath;
          callback = jasmine.createSpy('callback');
          ...
          return waitsFor('waiting for init to complete', function() {
            return callback.callCount === 1;
          });
        });
        ...
        return it("unescapes escaped dollar signs `$` in snippets", function() {
          ...
          return expect(forLoopBody).toBe("for (my $${1:var} = 0; $$1 < ${2:expression}; $$1++) {\n\t${3:# body...}\n}\n");
        });
      });
    });
    describe("when creating a theme", function() {
      ...
      return describe("when converting a TextMate theme", function() {
        it("generates the proper file structure", function() {
          var callback, textMateThemePath;
          callback = jasmine.createSpy('callback');
        ...
        return it("logs an error if it doesn't have all the required color settings", function() {
          ...
          return runs(function() {
            return expect(callback.argsForCall[0][0].message.length).toBeGreaterThan(0);
          });
        });
      });
    });
    return describe("when creating a language", function() {
      ...
      return it("does not add language prefix to name if already present", function() {
        ...
        return runs(function() {
          return expect(fs.existsSync(languagePath)).toBeTruthy();
        });
      });
    });
  });
