...
describe('apm upgrade', () => {
  var atomApp, atomHome, packagesDir, server
  ...
  beforeEach(() => {
    ...
    const app = express()
    app.get('/packages/test-module', (_request, response) => response.sendFile(path.join(__dirname, 'fixtures', 'upgrade-test-module.json')));
    app.get('/packages/multi-module', (_request, response) => response.sendFile(path.join(__dirname, 'fixtures', 'upgrade-multi-version.json')));
    app.get('/packages/different-repo', (_request, response) => response.sendFile(path.join(__dirname, 'fixtures', 'upgrade-different-repo.json')));
