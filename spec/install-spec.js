    ...
    describe("with a space in node-gyp's path", function () {
      ...
      it("builds native code successfully", function () {
        ...
        runs(function () {
          ...
          const makefileContent = fs.readFileSync(path.join(testModuleDirectory, "build", "config.gypi"), {
            encoding: "utf-8",
          })
          expect(makefileContent).toMatch('# Do not edit. File was generated by node-gyp\'s "configure" step')
        })
      })
    })
  })
