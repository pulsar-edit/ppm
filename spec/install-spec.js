  ...
  describe('when installing an atom package', () => {
    ...
    describe('::cloneFirstValidGitUrl', () => {
      describe('when cloning a URL fails', () => {
        ...
        beforeEach(() => {
          install = new Install()
          const fakeCloneRepository = function () {
    ...
    describe('::getPackageDependencies', () => {
      var originalPath, packageDependencies
    ...
    describe("with a space in node-gyp's path", () => {
      ...
      beforeEach(() => {
        const nodeGypPath = path.dirname(path.dirname(require.resolve('node-gyp')))
