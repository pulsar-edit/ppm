...
describe('apm link/unlink', function() {
  ...
  describe("when the dev flag is false (the default)", () => it('symlinks packages to $ATOM_HOME/packages', function() {
  ...
  describe("when the dev flag is true", () => it('symlinks packages to $ATOM_HOME/dev/packages', function() {
    const atomHome = temp.mkdirSync('apm-home-dir-');
    process.env.ATOM_HOME = atomHome;
    const packageToLink = temp.mkdirSync('a-package-');
    process.chdir(packageToLink);
  ...
  describe("when the hard flag is true", () => it("unlinks the package from both $ATOM_HOME/packages and $ATOM_HOME/dev/packages", function() {
    const atomHome = temp.mkdirSync('apm-home-dir-');
    process.env.ATOM_HOME = atomHome;
    const packageToLink = temp.mkdirSync('a-package-');
    process.chdir(packageToLink);
  ...
  describe("when the all flag is true", () => it("unlinks all packages in $ATOM_HOME/packages and $ATOM_HOME/dev/packages", function() {
    const atomHome = temp.mkdirSync('apm-home-dir-');
    process.env.ATOM_HOME = atomHome;
  ...
  describe("when the package name is numeric", () => it("still links and unlinks normally", function() {
    const atomHome = temp.mkdirSync('apm-home-dir-');
    process.env.ATOM_HOME = atomHome;
  ...
  describe("when the package name is set after --name", () => it("still links and unlinks normally", function() {
    const atomHome = temp.mkdirSync('apm-home-dir-');
    process.env.ATOM_HOME = atomHome;
  ...
  describe("when unlinking a path that is not a symbolic link", () => it("logs an error and exits", function() {
    const callback = jasmine.createSpy('callback');
  ...
  return describe("when unlinking a path that does not exist", () => it("logs an error and exits", function() {
    const callback = jasmine.createSpy('callback');
